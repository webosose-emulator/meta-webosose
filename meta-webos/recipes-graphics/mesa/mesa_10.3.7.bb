...
SRC_URI = "file://MesaLib-${PV}.tar.bz2 \
...
# Add enable wayland even without wayland in DISTRO_FEATURES
PACKAGECONFIG_append = " wayland"

# Add svga gallium driver
GALLIUMDRIVERS = "swrast,svga"

# Enable wayland even without wayland in DISTRO_FEATURES
EGL_PLATFORMS = "drm,wayland"
